...
export const useAppStore = create<StoreState>()(
  persist(
    ...
    {
      name: "mtra-storage-v3",
      onRehydrateStorage: () => (state) => {
        if (state) {
          state.setHasHydrated(true);
          // Ensure mock cases reflect correct unread dots (SUP-2026-0001 & SUP-2026-0004 unread, SUP-2026-0003 read)
          state.supportCases = state.supportCases.map((sc) => {
            if (sc.id === "SUP-2026-0004" || sc.id === "SUP-2026-0001") {
              return { ...sc, unread: true };
            }
            if (sc.id === "SUP-2026-0003") {
              return { ...sc, unread: false };
            }
            return sc;
          });
        }
