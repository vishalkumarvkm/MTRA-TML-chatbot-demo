  ...
  return (
    <div className="flex flex-col h-screen bg-background overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-[#008573] text-white text-[9px] font-bold rounded-full flex items-center justify-center">
      ...
      {pathname === "/" && (
        ...
        >
          <h1 className="text-white font-display font-normal text-xl sm:text-2xl md:text-3xl tracking-wide text-left">
            Welcome to the HealthyME Tuition Portal
          </h1>
          <Button
            onClick={() => router.push("/apply")}
            className="rounded-full bg-white text-[#003769] hover:bg-slate-100 font-bold px-6 py-2.5 sm:py-3 shadow-md shrink-0 w-full sm:w-auto text-center justify-center border-0 transition-all"
            ...
            {filteredNav.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "flex items-center gap-3 rounded-none px-3 py-2.5 text-sm font-medium transition-all duration-150 group",
                    isActive
                      ? "bg-[#E6F0F5] text-[#003769] font-bold"
                      : "text-slate-600 hover:bg-[#E6F0F5]/50 hover:text-[#003769]",
                  )}
