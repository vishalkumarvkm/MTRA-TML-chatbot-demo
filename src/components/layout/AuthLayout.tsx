  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      >
        ...
        {/* Logo */}
        {/* Logo removed from left panel per spec - shown only once on right panel */}
        <div className="relative z-10 space-y-8 flex flex-col items-start">
          ...
          >
            HealthyME Tuition Portal
          </h2>
          <p className="text-white/70 text-sm leading-relaxed max-w-xs">
            AI-powered tuition reimbursement management for Montefiore Medical
            Center employees.
          </p>
        </div>
        ...
        <div className="relative z-10">
          <p className="text-white/40 text-xs">
            &copy; {new Date().getFullYear()} Montefiore Medical Center. Powered
            by HealthyME.
          </p>
        </div>
      </div>
