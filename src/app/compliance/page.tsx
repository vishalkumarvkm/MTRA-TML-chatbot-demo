      ...
      <div className="p-6 space-y-6 max-w-[1600px] mx-auto bg-muted/20 min-h-full">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Continuous audit-readiness | NYSNA Adherence | Tax Split |
              Immutable Logs
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            {
              label: "NYSNA Adherence",
              value: "98.2%",
              sub: "45-day window met",
              icon: Activity,
              color: "emerald",
            },
            {
              label: "IRS §127 Utilization",
              value: "$528k",
              sub: "Tax-free optimization",
              icon: PieChart,
              color: "blue",
            },
            {
            ...
            <Card key={i} className="border-border shadow-sm">
              <CardContent className="p-5">
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div
                    className={`p-1.5 rounded-lg bg-muted/50 text-${stat.color}-600`}
                  >
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-sm font-bold">
                    NYSNA Article 35 Adherence (Monthly)
                  </CardTitle>
            ...
            <Card className="border-border shadow-sm overflow-hidden">
              ...
              <CardContent className="p-0">
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-muted/10">
                        <TableHead className="text-[10px] font-bold uppercase px-6 h-10">
                          Timestamp
                        </TableHead>
                        ...
                        <TableHead className="text-[10px] font-bold uppercase h-10 text-right pr-6">
                          SHA-256
                        </TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {mockAuditEntries.slice(0, 8).map((log, i) => (
                        ...
                        >
                          <TableCell className="px-6 text-[10px] font-mono text-muted-foreground whitespace-nowrap">
                            {log.timestamp}
                          </TableCell>
                          <TableCell>
                            <div className="flex items-center gap-2">
                              ...
                              <Badge
                                variant="outline"
                                className="text-[8px] h-3.5 px-1 font-mono uppercase tracking-tighter"
                              >
                                {log.actorRole}
                              </Badge>
                            </div>
                ...
                <Button
                  variant="ghost"
                  className="w-full h-10 text-[10px] font-bold text-muted-foreground border-t border-border rounded-none"
                >
            ...
            <Card className="border-primary/20 bg-primary/5 shadow-sm overflow-hidden">
              ...
              <CardContent className="p-4 space-y-4">
                {[
                  {
                    id: "nysna",
                    label: "NYSNA Compliance Report",
                    desc: "Article 35 adherence data for Labor Relations.",
                  },
                  {
                    id: "127",
                    label: "IRS §127 Reconciliation",
                    desc: "Year-to-date taxable fringe benefit split.",
                  },
                  {
                    id: "spend",
                    label: "Spend Summary by Dept",
                    desc: "Detailed budget utilization by cost center.",
                  },
                ].map((report) => (
                  <div
                    key={report.id}
                    className="p-3 bg-white rounded-xl border border-primary/10 space-y-2 group hover:border-primary/30 transition-all shadow-sm"
                  >
                ...
                {[
                  {
                    ...
                    text: "Department 'Internal Medicine' exceeded 90% of budget 4 months early.",
                    priority: "high",
                  },
                  {
                    title: "Policy Exception Pattern",
                    text: "Multiple 'B-' grade approvals detected in NYSNA pool.",
                    priority: "medium",
                  },
                ].map((alert, i) => (
                  <div
                    key={i}
                    className="bg-white p-3 rounded-xl border border-amber-200 space-y-2 shadow-sm"
                  >
                    <div className="flex justify-between items-start">
                      ...
                      <div
                        className={`w-1.5 h-1.5 rounded-full ${alert.priority === "high" ? "bg-destructive animate-pulse" : "bg-amber-500"}`}
                      />
                    </div>
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-6 text-[9px] px-2 text-amber-700 hover:bg-amber-50 gap-1 font-bold"
                    >
            ...
            <Card className="border-border shadow-sm bg-card">
              ...
              <CardContent className="p-4 space-y-4">
                ...
                <p className="text-[9px] text-muted-foreground leading-relaxed italic text-center">
                  All platform actions are cryptographically signed and
                  cross-referenced with Workday HRIS for integrity.
                </p>
              </CardContent>
            </Card>
          </aside>
