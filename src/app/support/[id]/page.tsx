              ...
              <div className="flex flex-wrap items-center gap-2">
                {supportCase.status !== "Resolved" &&
                  ...
                  (userRole === "manager" || userRole === "admin") && (
                    <Button
                      ...
                      className="h-7 text-xs px-3.5 gap-1 bg-[#008573] text-white hover:bg-[#006e5f] rounded-full border-0 font-bold shadow-xs"
                    >
                ...
                {supportCase.status !== "Closed" && (
                  <Button
                    ...
                    className="h-7 text-xs px-3.5 gap-1 bg-[#003769] text-white hover:bg-[#00274d] rounded-full border-0 font-bold shadow-xs"
                  >
