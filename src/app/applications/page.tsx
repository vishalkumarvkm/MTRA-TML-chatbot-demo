      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-left">
          ...
          <Button
            ...
            className="gap-2 w-full sm:w-auto rounded-full bg-[#003769] text-white hover:bg-[#00274d] border-0 font-bold text-xs shadow-xs"
          >
        ...
        {isNYSNA && serviceAgreement && (
          <Card
            className="border border-slate-200 rounded-none bg-white shadow-none p-4 md:p-6"
            ...
            <CardContent className="p-0 space-y-4 text-left">
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  <FileSignature className="w-5 h-5 text-[#003769]" />
                  <h3 className="text-base font-bold font-body text-[#003769]">
                    NYSNA Service Agreement
                  </h3>
                  <Badge className="text-xs font-bold border-0 bg-[#ebf3ef] text-[#008573] rounded-full px-2.5 py-0.5">
                    {serviceAgreement.status === "ExpiringSoon"
                      ? "Expiring Soon"
                      : serviceAgreement.status}
                  </Badge>
                </div>
                <span className="text-xs font-bold text-[#003769] uppercase tracking-wider">
                  NYSNA ARTICLE 35
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-2">
                ...
                <div className="flex items-start gap-2.5">
                  <CalendarCheck2 className="w-4.5 h-4.5 text-[#003769] mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="text-[10px] font-bold text-[#003769] uppercase tracking-wider font-body">
                      Date Signed
                    </p>
                    <p className="text-sm font-bold text-[#1A1A1A] mt-0.5 font-body">
                ...
                {/* Amount Covered */}
                <div className="flex items-start gap-2.5">
                  <FileSignature className="w-4.5 h-4.5 text-[#008573] mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="text-[10px] font-bold text-[#003769] uppercase tracking-wider font-body">
                      Amount Covered
                    </p>
              ...
              {/* Bottom Footer Note */}
              <p className="text-[11px] text-slate-600 mt-4 leading-relaxed border-t border-slate-100 pt-3 font-body">
